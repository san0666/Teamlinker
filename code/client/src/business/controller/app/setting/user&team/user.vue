<template>
  <div ref="root">
    <a-space>
      ...
      <a-button type="primary" @click="onInvite" v-if="$deployMode.value===ECommon_Application_Mode.ONLINE">{{$t("util.invite")}}</a-button>
	    <a-button type="primary" @click="onCreate" v-else>{{$t("util.create")}}</a-button>
    </a-space>
